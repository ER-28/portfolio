...
const HeroSection = () => {
  ...
  const stats = [
    {label: t.hero.stats.experience, value: `${new Date().getFullYear() - 2023}+ Years`},
    {label: t.hero.stats.projects, value: String(projectOverview.caseStudies.length + projectOverview.sideProjects.length + featuredWork.length)},
    {label: t.hero.stats.openSource, value: "3+"},
    {label: t.hero.stats.location, value: SITE.location},
  ];
          ...
          <div className="flex flex-col items-center text-center gap-8">
            ...
            <div className="animate-hero-fade-in flex flex-col sm:flex-row items-center gap-4" style={{animationDelay: "350ms"}}>
              ...
              <div className="flex items-center gap-3">
                <Button className="h-auto rounded-lg p-0 glow-card hidden sm:inline-flex">
                  <Link
                  ...
                  >
                    <span className="flex items-center gap-2.5 bg-accent text-accent-foreground hover:bg-accent/90 py-2.5 px-5 rounded-lg transition-all duration-300">
                      ...
                      <span className="text-sm sm:text-base font-semibold">{t.hero.contact}</span>
                    </span>
                  </Link>
                </Button>
              </div>
