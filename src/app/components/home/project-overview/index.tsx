          ...
          <div className="flex flex-col max-w-3xl mx-auto gap-10 sm:gap-16 px-4 sm:px-7 py-9 md:py-16 ">
            <div className="flex flex-col xs:flex-row items-start gap-5 xs:gap-10 md:gap-28 lg:gap-5">
              ...
              <div className="flex flex-col gap-2.5">
                {projectOverview?.caseStudies?.map((value: any, index: any) => {
                  return (
                    <Link
                      key={index}
                      href={value?.url}
            ...
            <div className="flex flex-col xs:flex-row items-start gap-5 xs:gap-10 md:gap-28 lg:gap-5">
              ...
              <div className="flex flex-col gap-2.5">
                {projectOverview?.sideProjects?.map((value: any, index: any) => {
                  ...
                  return isComingSoon ? (
                    ...
                    <Link key={index} href={value?.href} className="group" target={"_blank"}>
                      {content}
                    </Link>
                  );
                })}
