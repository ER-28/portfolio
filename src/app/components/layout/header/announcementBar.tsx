...
const AnnouncementBar = () => {
    return (
        <Link href="https://github.com/ER-28/nestjs-response-wrapper" target="_blank" rel="noreferrer">
                ...
                <div className="group relative bg-primary overflow-hidden">
                    ...
                    <div className="relative z-10 container">
                        <div className="py-2.5 flex items-center justify-center gap-2">
                            ...
                            <Image src={"/portfolio/images/icon/arrow-icon.svg"} alt="arrow-icon" width={24} height={24} className="group-hover:translate-x-1.5 transition-all duration-500 ease-in-out" />
                        </div>
                    </div>
                </div>
            </div>
